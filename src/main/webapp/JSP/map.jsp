...
String list = vo.getAcc_place();
%>
<%-- <%
request.setCharacterEncoding("utf-8");
String name_1 = request.getParameter("name");
ReportVO reportVO = new ReportVO();
reportVO.setAcc_place(name_1);
ReportDAO dao = new ReportDAO();
List postionList = dao.postionList();

// reportVO 에 있는 acc_place의 모든 정보를 list에 담기!!
                  ...
                  if (status == kakao.maps.services.Status.OK) {
                     var arr = new Array(3);
                      ...
                      console.log(coords.La);//위도
                       ...
                       arr[0]=coords.La;
                       arr[1]=coords.Ma;
                       arr[2]='<div style="padding:5px;">'+json[i].acc_place+'</div>';
                       console.log(arr)
