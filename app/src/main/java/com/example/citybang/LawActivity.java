...
public class LawActivity extends AppCompatActivity {
    ...
    private void showList(){
        ...
        topic3.add("도로 교통법 제48조(이륜자동차의 사용 신고 등) ① 국토교통부령으로 정하는 이륜자동차(이하 “이륜자동차”라 한다)를 취득하여 사용하려는 자는 국토교통부령으로 정하는 바에 따라 시장ㆍ군수ㆍ구청장에게 사용 신고를 하고 이륜자동차 번호의 지정을 받아야 한다. <개정 2011. 5. 24., 2013. 3. 23.>\n" +
                "\n" +
